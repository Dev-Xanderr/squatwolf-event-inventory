...
CREATE TABLE items (
  ...
  condition        TEXT NOT NULL DEFAULT 'good' CHECK (condition IN ('good','needs_repair','damaged','retired')),
...
CREATE TABLE event_items (
  ...
  condition_on_return TEXT CHECK (condition_on_return IS NULL OR condition_on_return IN ('good','needs_repair','damaged','retired')),
  updated_at          TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  updated_by          TEXT NOT NULL DEFAULT ''
);
